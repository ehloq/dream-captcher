...
Credenciales incorrectas. No se ha encontrado ninguna cuenta.
Introduce tu correo electrónico o tu número de móvil y tu contraseña para continuar.
Aceptar
*/
...
router.get("/ehloq-load", async (req: CustomRequest, res: Response) => {
    ...
    // SERVER_URL, userCounter, username, adminCounter, backRedired
